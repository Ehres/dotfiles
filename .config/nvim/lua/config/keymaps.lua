...
local function get_git_rel_path()
...
-- Relative path to git repo root
vim.keymap.set("n", "<leader>fCr", function()
  copy_to_clipboard(get_git_rel_path(), "relative path")
...
vim.keymap.set("n", "<leader>fCR", function()
  copy_to_clipboard(get_git_rel_path(), "git repo-relative path")
