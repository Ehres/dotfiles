...
# Inter-group gap (right-side bar)
export GROUP_GAP_RIGHT=$GAP_GROUP
...
# Network group — bookend pattern (icon-only items)
export NETWORK_ITEM_PADDING=$GAP_NONE
export NETWORK_ICON_PADDING=$PADDING_DEFAULT
export NETWORK_BOOKEND_ICON_PADDING=$PADDING_RELAXED
...
# Updates group (brew, nvim) — bookend pattern
export UPDATES_ITEM_PADDING=$GAP_NONE
export UPDATES_ICON_PADDING=$PADDING_DEFAULT
export UPDATES_FIRST_ICON_PADDING=$PADDING_RELAXED
export UPDATES_LAST_ICON_PADDING=$PADDING_RELAXED
export UPDATES_LABEL_PADDING_LEFT=$PADDING_TIGHT
export UPDATES_LABEL_PADDING_RIGHT=$PADDING_DEFAULT
export UPDATES_LAST_LABEL_PADDING=$PADDING_RELAXED
