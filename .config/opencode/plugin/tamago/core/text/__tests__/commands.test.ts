...
test("COMMAND_IDS lists the seven palette commands; every title is filed under Tamago, never carries the Name, and the pet description mentions it", () => {
  assert.deepEqual(COMMAND_IDS, ["mute", "card", "pet", "rename", "hatch", "roster", "choose"]);
