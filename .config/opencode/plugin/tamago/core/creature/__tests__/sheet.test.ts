...
import { freshCareer } from "../../career/career.ts";
...
const table: readonly Species[] = [
  ...
  { id: "pusher", label: { en: "pusher", fr: "pousseur" }, gender: "m", rarity: "common", sheet: { stoic: 2, cheerful: -1, energy: 3, chatter: -3 } },
  { id: "always", label: { en: "always", fr: "toujours" }, gender: "m", rarity: "common", sheet: { stoic: 12 } },
];
...
test("the Speaker of a Career is derived once, and a table of its own never touches that cache", () => {
  const cached = speakerOf(career);
